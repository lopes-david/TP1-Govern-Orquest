...
Referencia os buckets existentes (raw/bronze/silver) pelo nome via contexto CDK.
"""
from aws_cdk import (
    Stack, Duration,
...
class GlueStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs):
        ...
        self.scripts_bucket = self.node.try_get_context("scripts_bucket") or "meu-datalake-glue-scripts"
